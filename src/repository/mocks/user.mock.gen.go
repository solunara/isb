...
// Source: E:\code\golang\isb\src\repository\user.go
//
...
func (m *MockUserRepository) EditProfile(ctx context.Context, u repository.User) (repository.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindById(ctx context.Context, uid int64) (repository.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindByWechat(ctx context.Context, openID string) (repository.User, error) {
	m.ctrl.T.Helper()
